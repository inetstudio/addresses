...
namespace InetStudio\AddressesPackage\Points\Http\Responses\Back\Utility;
...
class SuggestionsResponse implements SuggestionsResponseContract
{
    ...
    public function toResponse($request)
    {
        $transformer = app()->make(
            'InetStudio\AddressesPackage\Points\Contracts\Transformers\Back\Utility\SuggestionTransformerContract',
            [
                'type' => $this->type,
            ]
        );
